...
<html>
<head>
    <title>PCPARTIFY | Register</title>
        ...
        <div class="grid lg:grid-cols-12 lg:grid-rows-6 lg:h-screen">
            ...
            <div class="font-[Poppins] max-lg:mt-4 lg:row-span-4 lg:row-start-2 lg:col-start-7 lg:col-span-5 lg:bg-[#FDFDFD] lg:shadow-xl lg:border-2 lg:rounded-r-2xl">
                ...
                <form method="POST" action="../proses/registrasi.php" >
                    <h1 class="text-center text-3xl font-extrabold tracking-tight lg:mt-6 ">Sign up</h1>
                    ...
                    <div class="relative flex mt-4 border-b-2 border-gray-400 mx-16">
                      ...
                      <input class=" focus:outline-none bg-transparent py-1 pl-2 w-full placeholder-gray-500" type="text" name="email" id="email" placeholder="Email">
                    </div>
                    ...
                    <div class="relative flex mx-16 mt-4 shadow1">
                        <input class="duration-200 bg-purple-700 border-[3px] border-transparent text-white py-1 text-center rounded-xl cursor-pointer hover:bg-transparent hover:border-purple-700 hover:text-purple-700 w-full" type="submit" value="Register">
                    </div>
                </form>
                ...
                <div class="m-3">
                    <div class="bg-[#001524] shadow1 p-6 lg:p-3 lg:mx-6 rounded-xl">
                        <!-- text 2 -->
                        <p class="font-[Poppins] mt-2 text-center text-gray-300">Please register yourself to continue</p>
                        <!-- garis /or/ -->
